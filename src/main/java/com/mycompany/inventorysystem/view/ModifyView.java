...
public class ModifyView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Modify Product info");
    ...
    private void btnLoadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadActionPerformed
        ...
        control.modifyProduct(PROD, productName, productDescription, price, stock, catId, suppId);
        JOptionPane.showMessageDialog(null, "MODIFY successfully.", "Title", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void loadProductData(int prodId) {
        loadComboboxData();
        this.PROD = control.getProduct(prodId);
        
        txtId.setText(String.valueOf(PROD.getProdId()));
        txtDescription.setText(PROD.getProdDesc());
        txtName.setText(PROD.getProdName());
        txtPrice.setText(PROD.getProdPrice().toString());
        txtStock.setText(String.valueOf(PROD.getProdStock()));
        cbCategory.setSelectedIndex(PROD.getCategory().getCatId());
        cbSupplier.setSelectedIndex(PROD.getSupplier().getSuId());
